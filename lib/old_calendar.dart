    ...
    return GestureDetector(
        ...
        child: Container(
            ...
            child: Badge(
                ...
                badgeContent:
                    Text(getOldCalEventsOnDate(date).length.toString()),
                showBadge: getOldCalEventsOnDate(date).isNotEmpty,
                child: Padding(
...
class OldCalendarPage extends StatefulWidget {
  const OldCalendarPage({Key? key}) : super(key: key);

  @override
  _OldCalendarPageState createState() => _OldCalendarPageState();
}
